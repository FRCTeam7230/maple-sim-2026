...
public class ElevatorSubsystem extends SubsystemBase
{
  ...
  private boolean atLowerLimit() {
    return getHeight() <= (ElevatorConstants.kMinElevatorHeightMeters + kLimitBufferMeters);
  }

  private boolean atUpperLimit() {
    return getHeight() >= (ElevatorConstants.kMaxElevatorHeightMeters - kLimitBufferMeters);
  }
