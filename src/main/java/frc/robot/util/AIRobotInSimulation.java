...
public class AIRobotInSimulation implements Subsystem {
    ...
    private static Command doNothing() {
        return Commands.runOnce(() -> System.out.println("Do nothing"));
    }

    public static void startOpponentRobotSimulations() {
        try {
            instances[0] = new AIRobotInSimulation(
                    PathPlannerPath.fromPathFile("Disrupt Path"),
                    Commands.none(),
                    PathPlannerPath.fromPathFile("Disrupt Path"),
                    Commands.none(),
            ...
            instances[1] = new AIRobotInSimulation(
                PathPlannerPath.fromPathFile("Disrupt Path 2"),
                doNothing(),
                PathPlannerPath.fromPathFile("Disrupt Path 2"),
                Commands.none(),
            ...
            instances[2] = new AIRobotInSimulation(
                PathPlannerPath.fromPathFile("The circle"),
                doNothing(),
                PathPlannerPath.fromPathFile("The circle"),
                Commands.none(),
    ...
    public AIRobotInSimulation(
        ...
        //     segment0,
        //     toRunAtEndOfSegment0,
        //     segment1,
        //     toRunAtEndOfSegment1,
    ...
    SendableChooser<Command> behaviorChooser = new SendableChooser<>();
        final Supplier<Command> disable =
                () -> Commands.runOnce(
                        () -> driveSimulation.setSimulationWorldPose(ROBOT_QUEENING_POSITIONS[0]), this)
        ...
        //behaviorChooser.addOption("Joystick Drive", driveSimulation.joystickDrive(joystick));
